        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="${pageContext.request.contextPath}/"
               class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
                <img src="https://img.icons8.com/plasticine/100/000000/island-on-water.png" width="50" height="50"/>
            </a>
...
<script>
    ...
    document.querySelectorAll('header ul a').forEach(link => {
        if (url.endsWith(link.getAttribute('href')) || url.endsWith(`link.getAttribute('href')#`)) {
